      ...
      <p>你的选择，我们的骄傲</p>
		<table class="table table-hover" >
            ...
            <tr>
                ...
                <td>${order.money}</td> 
                <td><a class="btn btn-primary" href="getorder?good_id=${good.good_id}" role="button" >确认收货</a></td>
                <td><a class="btn btn-primary" href="comment?good_id=${good.good_id}" role="button" >评论</a></td>  
            </tr>
            </c:forEach>
            </c:forEach>
        </table>
