        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          ...
          <div class="table-responsive">
            <table class="table table-striped">
              <thead>
                <tr>
                  <th class="good">商品编号</th>
                  <th class="good">商品名称</th>
                  <th class="good">商品图片</th>
                  <th class="good">产商</th>
                  <th class="good">商品类型</th>
                  <th class="good">商品库存</th>
                  <th class="good">商品价格</th>
                  <th >商品介绍</th>
                  <th>删除</th>
                  <th>修改</th>
                </tr>
              ...
              <tbody>
               <c:forEach items="${requestScope.pants_list}" var="good">  
                <tr>
                  <td>${good.good_id}</td>
                  ...
                  <td><a class="btn btn-primary" href="removegood?good_id=${good.good_id}" role="button" >删除</a></td>
                  <td><a class="btn btn-primary" href="goodupdate?good_id=${good.good_id}" role="button" >修改</a></td>
                </tr>
                </c:forEach>
              </tbody>
            </table>
