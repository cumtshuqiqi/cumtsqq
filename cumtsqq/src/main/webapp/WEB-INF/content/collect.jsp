      ...
      <p>你的选择，我们的骄傲</p>
		...
		<td class="coat">立即购买</td>
            ...
            <tr>
                ...
                <td><a class="btn btn-info" href="removecollect?good_id=${good.good_id}" role="button">删除</a></td> 
                <td><a class="btn btn-danger" href="save?good_id=${good.good_id}" role="button">加入购物车</a></td> 
                <td><a class="btn btn-success" href="removeorder?good_id=${good.good_id}" role="button">立即购买</a></td> 
            </tr>
            </c:forEach>
            </c:forEach>
        </table>
